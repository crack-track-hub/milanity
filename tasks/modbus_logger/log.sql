...
-- Generic table: one row per reading per poll cycle, rather than one
-- fixed-width row per device. This is what lets config.json add/remove
-- readings or whole devices without ever touching the schema.
